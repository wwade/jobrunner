...
class TestRenderTreeNode( unittest.TestCase ):
   ...
   def setUp( self ):
      ...
      self.jobs._renderTreeNode = db.JobsBase._renderTreeNode.__get__(
         self.jobs
      )
...
class TestListDbTreeDisplay( unittest.TestCase ):
   ...
   def _makeJobsBase( self, activeJobs ):
      ...
      activeDb.filterJobs.side_effect = (
         lambda k: k not in db.DatabaseMeta.special
      )
   ...
   def test_inactiveDbUseFlatList( self ):
      ...
      inactiveDb.filterJobs.side_effect = (
         lambda k: k not in db.DatabaseMeta.special
      )
      jobList = list( dbDict.values() )
